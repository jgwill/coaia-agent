...
RUN apt-get update && \
    ...
    build-essential curl wget ca-certificates gnupg nodejs npm python3 ripgrep ffmpeg gcc python3-dev libffi-dev procps git openssh-client docker-cli tini neovim vim less jq && \
