...
2.  **Maintaining State**: Archiving session-specific data to `/src/_sessiondata`.
...
| :--- | :--- | :--- |
| `OPENCLAW_SESSIONDATA_ROOT` | Root directory for event logs. | `/src/_sessiondata` |
...
```
Check for the existence of `/src/_sessiondata/test-weaving/` to confirm.
